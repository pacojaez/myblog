<template>
  <header class="bg-black relative z-1000 bg-radial-t-gray-to-black" id="header">
    ...
    <div class="logo pt-0 pb-16 md:pb-32 md:pt-16 container mx-auto text-center text-white bannerheader">
      <h2 class="m-0">
        <!-- <span class="text-4xl">
          <font-awesome :icon="['fas', 'ghost']" class="mb-1 mr-3"></font-awesome>
        </span> -->
        <span class="text-6xl text-white title">{{ $static.metadata.siteName }}</span>
      </h2>
      <div class="text-gray-400 font-thin text-2xl">{{ $static.metadata.siteDescription }}</div>
    </div>
  </header>
</template>
...
.bannerheader{
  background-image: '~/assets/images/bannerheader.jpg' !important;
